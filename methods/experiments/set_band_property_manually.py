...
def main():
    _tuples = [
        ...
        ('SN44', 5, 'cells_1_3', False),
        ('SN44', 5, 'cells_2_3', True),

        ('SN44', 6, 'cells_1_3', False),
        ('SN44', 6, 'cells_1_4', False),
        ('SN44', 6, 'cells_1_6', False),
        ('SN44', 6, 'cells_3_4', True),
        ('SN44', 6, 'cells_3_6', False),
        ('SN44', 6, 'cells_4_6', False),
