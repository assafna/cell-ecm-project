...
TIME_LAG = 1
TIME_LAG_INDEX = \
    np.where(np.array(same_inner_correlation_vs_different_inner_correlation_cross_correlation.TIME_LAGS) == TIME_LAG)[
        0][0]
                ...
                if _name in _plots:
                    ...
                    for _type_sums in _sums:
                        ...
                        for _time_lag, _type_sum in zip(
                                same_inner_correlation_vs_different_inner_correlation_cross_correlation.TIME_LAGS,
                                _type_sums):
                            if _time_lag > 0:
