...
def compute_data(_arguments):
    ...
    for _same_index in range(len(_simulations)):
        ...
        _same_left_cell_fiber_densities = _fiber_densities[(_same_simulation, _offset_y, 'left_cell')]
        _same_right_cell_fiber_densities = _fiber_densities[(_same_simulation, _offset_y, 'right_cell')]
            ...
            if _same_index != _different_index:
                ...
                for _same_cell_id, _different_cell_id in product(['left_cell', 'right_cell'],
                    ...
                    _same_fiber_densities = \
                        _fiber_densities[(_same_simulation, _offset_y, _same_cell_id)]
                    _different_fiber_densities = \
                        _fiber_densities[(_different_simulation, _offset_y, _different_cell_id)]
...
def compute_array(_low_connectivity):
    global _simulations, _fiber_densities, _array, _significant_x_array
