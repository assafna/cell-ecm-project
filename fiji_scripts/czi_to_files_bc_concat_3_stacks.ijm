...
third_file_path = raw_path + experiment + "/Rep_Loc_4h30minto8hPostseed_postBlebb.czi";
...
for (s = 1; s <= 24; s++) {
	...
	rename("third");
	run("8-bit");
	run("Concatenate...", "  title=new_image open image1=first image2=second image3=third image4=[-- None --]");
