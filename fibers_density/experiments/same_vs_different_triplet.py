...
def main():
    ...
    _experiments = filtering.by_series_id(_experiments, SERIES_ID)
    _experiments = filtering.by_cells_ids(_experiments, CELLS_IDS, _both_cells=True)
        ...
        for _different_index in range(len(_experiments)):
            if _same_index != _different_index:
                ...
                for _same_cell_id, _different_cell_id in product(['left_cell', 'right_cell'],
                    ...
                    # if _same_properties['cells_ids'][_same_cell_id] == _different_properties['cells_ids'][_different_cell_id]:
