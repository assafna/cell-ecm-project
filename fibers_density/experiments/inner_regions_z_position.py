...
def compute_fibers_densities(_band=True, _high_time_resolution=False):
    ...
    print(pearsonr(_correlations_array, _z_positions_array))

    return _correlations_array, _z_positions_array


def main(_band=True, _high_time_resolution=False):
    _correlations_array, _z_positions_array = compute_fibers_densities(_band, _high_time_resolution)
    ...
    _fig = go.Figure(
        ...
        layout={
            ...
            'yaxis': {
                'title': 'Inner region correlation',
                'zeroline': False,
                'range': [-1.1, 1.2],
                'tickmode': 'array',
