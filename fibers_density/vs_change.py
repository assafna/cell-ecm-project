...
def main():
    ...
    for _simulation in _simulations:
        for _cell_id in ['left_cell', 'right_cell']:
            _cell_fibers_densities = compute_simulation.roi_fibers_density_by_time(
            ...
            _change_in_fibers_densities_array += [0] + computations.derivative(_cell_fibers_densities, _n=DERIVATIVE)
